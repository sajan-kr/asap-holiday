...
const reviews = [
    {
        ...
        rating: 5,
        trip: "Dubai Holiday",
        review: "Amazing trip! Everything was perfectly organised. The hotels, sightseeing and transfers were excellent. We didn't have to worry about anything throughout the journey.",
    },
    {
        name: "Priya Verma",
        ...
        rating: 5,
        trip: "Bali Escape",
        review: "The entire Bali experience was beautifully planned. From airport transfers to sightseeing, everything was smooth and stress-free. Truly an unforgettable holiday.",
    },
    {
        name: "Pooja Singh",
        ...
        review: "Very good experience from beginning to end. The support team was helpful and all our travel arrangements were handled smoothly.",
    },
];
                ...
                >
                    ...
                    >
                        ...
                        {reviews.map((review, index) => (
                            ...
                            <div className="reviewSlide" key={review.name}>
                    ...
                    <div className="sliderControls">
                        ...
                        <button className="sliderArrow" onClick={previousReview} aria-label="Previous review">
                            <FaArrowLeft />
                        </button>
                        <div className="sliderDots">
                            {reviews.map((_, index) => (
                                <button key={index} className={active === index ? "sliderDot active" : "sliderDot"}
                        ...
                        <button className="sliderArrow" onClick={nextReview} aria-label="Next review">
                            <FaArrowRight />
                        </button>
                    </div>
                </div>
